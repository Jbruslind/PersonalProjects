...
//    }
    ...
    while(1)
    {
        ...
        vTaskDelay(250 / portTICK_RATE_MS); // Wait 100ms before restarting for loop
    }
    vTaskDelete( NULL ); //If we ever get here, we're in trouble (this will cleanly exit though)
}